import{d as p,c as m,g as u,u as b,o as f,h}from"./iframe-Dky8xwok.js";import{c as g}from"./cn-fNskMoFt.js";import"./preload-helper-Dp1pzeXC.js";const k=["checked","disabled"],x="h-5 w-5 rounded border-2 border-border bg-surface accent-accent shadow-[var(--shadow-button)] transition-all duration-[var(--duration-normal)] focus:ring-2 focus:ring-accent focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",n=p({__name:"UiCheckbox",props:{modelValue:{type:Boolean},disabled:{type:Boolean},class:{}},emits:["update:modelValue"],setup(e,{emit:s}){const d=s;return(l,o)=>(f(),m("input",{type:"checkbox",checked:e.modelValue,disabled:e.disabled,class:u(b(g)(x,l.$props.class)),onChange:o[0]||(o[0]=i=>d("update:modelValue",i.target.checked))},null,42,k))}});n.__docgenInfo={exportName:"default",displayName:"UiCheckbox",description:"",tags:{},props:[{name:"modelValue",description:"Bound checked state for v-model.",required:!1,type:{name:"boolean"}},{name:"disabled",description:"Disables interaction.",required:!1,type:{name:"boolean"}},{name:"class",description:"Additional classes merged via cn().",required:!1,type:{name:"string"}}],events:[{name:"update:modelValue",type:{names:["boolean"]}}],sourceFiles:["/Users/edwardnorton/Development/test-run/packages/ui/src/components/UiCheckbox.vue"]};const U={component:n,title:"UI/UiCheckbox",argTypes:{disabled:{control:"boolean"}}},a={args:{disabled:!1},render:e=>({components:{UiCheckbox:n},setup(){const s=h(!1);return{args:e,checked:s}},template:`
